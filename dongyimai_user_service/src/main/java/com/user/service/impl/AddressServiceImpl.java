...
import com.dongyimai.bean.TbAddress;
import com.dongyimai.bean.TbAddressExample;
import com.dongyimai.dao.TbAddressMapper;
...
public class AddressServiceImpl implements AddressService {
	...
	public List<TbAddress> findListByUserId(String userId) {
		...
		TbAddressExample.Criteria tbItemCatExample_criteria = tbAddressExample.createCriteria();
		tbItemCatExample_criteria.andUserIdEqualTo(userId);
